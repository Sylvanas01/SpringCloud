...
java -Dspring.datasource.url="jdbc:mysql://db.hzero.org:3306/hiot_db?useUnicode=true&characterEncoding=utf-8&useSSL=false" \
	 -Dspring.datasource.username=hiot_reader \
	 -Dspring.datasource.password=hiot_reader \
